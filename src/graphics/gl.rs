...
impl From<TextureFormat> for (GLenum, GLenum, GLenum) {
    fn from(format: TextureFormat) -> Self {
        ...
        match format {
            ...
            F::R8I => (GL_R8I, GL_RED_INTEGER, GL_BYTE),
            F::RG8I => (GL_RG8I, GL_RG_INTEGER, GL_BYTE),
            F::RGB8I => (GL_RGB8I, GL_RGB_INTEGER, GL_BYTE),
            F::RGBA8I => (GL_RGBA8I, GL_RGBA_INTEGER, GL_BYTE),
            F::R16I => (GL_R16I, GL_RED_INTEGER, GL_SHORT),
            F::RG16I => (GL_RG16I, GL_RG_INTEGER, GL_SHORT),
            F::RGB16I => (GL_RGB16I, GL_RGB_INTEGER, GL_SHORT),
            F::RGBA16I => (GL_RGBA16I, GL_RGBA_INTEGER, GL_SHORT),
            F::R32I => (GL_R32I, GL_RED_INTEGER, GL_INT),
            F::RG32I => (GL_RG32I, GL_RG_INTEGER, GL_INT),
            F::RGB32I => (GL_RGB32I, GL_RGB_INTEGER, GL_INT),
            F::RGBA32I => (GL_RGBA32I, GL_RGBA_INTEGER, GL_INT),
            F::R8UI => (GL_R8UI, GL_RED_INTEGER, GL_UNSIGNED_BYTE),
            F::RG8UI => (GL_RG8UI, GL_RG_INTEGER, GL_UNSIGNED_BYTE),
            F::RGB8UI => (GL_RGB8UI, GL_RGB_INTEGER, GL_UNSIGNED_BYTE),
            F::RGBA8UI => (GL_RGBA8UI, GL_RGBA_INTEGER, GL_UNSIGNED_BYTE),
            F::R16UI => (GL_R16UI, GL_RED_INTEGER, GL_UNSIGNED_SHORT),
            F::RG16UI => (GL_RG16UI, GL_RG_INTEGER, GL_UNSIGNED_SHORT),
            F::RGB16UI => (GL_RGB16UI, GL_RGB_INTEGER, GL_UNSIGNED_SHORT),
            F::RGBA16UI => (GL_RGBA16UI, GL_RGBA_INTEGER, GL_UNSIGNED_SHORT),
            F::R32UI => (GL_R32UI, GL_RED_INTEGER, GL_UNSIGNED_INT),
            F::RG32UI => (GL_RG32UI, GL_RG_INTEGER, GL_UNSIGNED_INT),
            F::RGB32UI => (GL_RGB32UI, GL_RGB_INTEGER, GL_UNSIGNED_INT),
            F::RGBA32UI => (GL_RGBA32UI, GL_RGBA_INTEGER, GL_UNSIGNED_INT),
